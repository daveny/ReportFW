    ...
    public class ReportController : Controller
    {
        ...
        public ActionResult RenderReport(string templateName)
        {
            try
            {
                ...
                // 3. A sablon feldolgozása az új, biztonságos TemplateProcessor-ral.
                // A FilterProcessorra már nincs szükség, a TemplateProcessor mindent kezel.
        ...
        public ActionResult GetFilterData(string query, string valueField, string textField)
        {
            try
            {
                // BIZTONSÁGI FIGYELMEZTETÉS: Nyers lekérdezés futtatása a kliensről veszélyes!
                // A 'query' paramétert validálni kellene egy engedélyezett listához,
                // vagy egy kulcsnak kellene lennie, ami alapján a szerver választja ki a biztonságos lekérdezést.
                DebugHelper.Log($"GetFilterData called with query: {query}");

                // A CS1501 hiba javítása: a biztonságos, paraméter nélküli overload hívása.
        ...
        public ActionResult UpdateChart()
        {
            try
            {
                // A kliensoldali script dekódolja a base64 tokent és 'token' néven küldi el.
                ...
                // Az új TemplateProcessor használata a token egyedi feldolgozására.
